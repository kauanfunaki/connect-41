...
// sidebar/shell. Mesmo layout centralizado que esta rota já usa pro estado
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="max-w-md text-center flex flex-col items-center gap-3">
        ...
        <p className="text-[13px] text-fg-muted">
          Não foi possível carregar este teste. Tente novamente ou entre em contato com quem enviou o link.
        </p>
